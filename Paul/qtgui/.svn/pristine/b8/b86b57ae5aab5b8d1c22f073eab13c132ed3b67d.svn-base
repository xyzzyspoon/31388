...
%  8  9 10 11 Pose x,y,h,tilt [m,m,rad,rad]: 0.000540908 0 0 -1.67142
% 12 .. 33 Edge sensor: left -0.030918 1, right 1.542261 1, values 381 368 399 1613 2449 2309 1561 329,
%    white 1, used 1, LEDhigh=0, xingVal=1.56 xlcnt=0 lvcnt=5,LineVal=1.00, lineLow=0, lineHi=0, edgeAngle=0.
whitelevel=[2447 2346 2088 2520 2452 2316 2458 1831];
blacklevel=[55 43 40 50 7 44 2 8];
% 34    Battery voltage [V]: 11.72
% 35 37 read sensor time [us]: 100 and ctrl time 540
%    white 1, used 1, LEDhigh=1, xingVal=4.28 xlcnt=0 lvcnt=5,LineVal=1.00, lineLow=0, lineHi=0, edgeAngle=0.
gain=1./(whitelevel - blacklevel);
%%
data1000 = load('../thit_on_ramp/thit_on_ramp_line_01.txt');
data1001 = load('thit_001.txt');
data1003 = load('thit_003.txt');
data1004 = load('thit_004.txt');
data1005 = load('thit_005.txt');
data1006 = load('thit_006.txt');
data1007 = load('thit_007.txt');
data1008 = load('thit_008.txt');
data1009 = load('thit_009.txt');
data1010 = load('thit_010.txt');
data1011 = load('thit_011.txt');
data1012 = load('thit_012.txt');
data1013 = load('thit_013.txt');
data1014 = load('thit_014.txt');
data1015 = load('thit_015.txt');
%%
dd = data1015;
fg = 1015;
data = dd;
...
plot(dd(:,1), data(:,13),':')
grid on
legend('left edge', 'left vel','right vel','left valid');
